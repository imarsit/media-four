...
jQuery(document).ready(function ($) {
	...
	$('body').append('<img src="/public/images/dome/ipad.png" alt="" class="hidden">' +
		'<img src="/public/images/dome/ipad-landscape.png" alt="" class="hidden">' +
		'<img src="/public/images/dome/iphone.png" alt="" class="hidden">' +
		'<img src="/public/images/dome/iphone-landscape.png" alt="" class="hidden">');
	...
	if (canvas != null) {
		...
		var imageSrc = '/public/images/dome/colorwheel1.png';
		switch ($(canvas).attr('var')) {
			case '2':
				imageSrc = '/public/images/dome/colorwheel2.png';
				break;
			case '3':
				imageSrc = '/public/images/dome/colorwheel3.png';
				break;
			case '4':
				imageSrc = '/public/images/dome/colorwheel4.png';
				break;
			case '5':
				imageSrc = '/public/images/dome/colorwheel5.png';
				break;
		}
		image.src = imageSrc;
	}
